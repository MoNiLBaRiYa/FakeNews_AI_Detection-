...
# City Coordinates Database for TruthGuard AI (Python version)
# Covers Indian cities with focus on Gujarat, especially small towns & talukas.
# Format: { 'city_key': { 'lat': float, 'lon': float, 'label': str, 'state': str } }
...
CITY_COORDS = {
    ...
    # ... (more cities can be added as needed, matching city-coords.js)
